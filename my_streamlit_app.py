...
# Assuming the CSV file is in the same directory as your script or in a designated folder within your project structure
data = pd.read_csv("C:/Users/khize/Study_Material/App_Project/Final_Data.csv")

# Check if the file exists before reading it
if os.path.exists("C:/Users/khize/Study_Material/App_Project/Final_Data.csv"):
    data = pd.read_csv("C:/Users/khize/Study_Material/App_Project/Final_Data.csv")
else:
    st.error(f"Error: File not found at \"C:/Users/khize/Study_Material/App_Project/Final_Data.csv\"")
    st.stop()
